...
presplash.filename = MyNotes.png

# (str) Icon of the application
icon.filename = My-Notes.ico
...
android.presplash_color = #B90000

# (list) Permissions
android.permissions = INTERNET,ACCESS_NOTIFICATIONS, READ_EXTERNAL_STORAGE, WRITE_EXTERNAL_STORAGE, READ_CONTACTS, WRITE_CONTACTS
